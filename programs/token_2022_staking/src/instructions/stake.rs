...
pub struct Stake<'info> {
    ...
    pub token_mint: InterfaceAccount<'info, token_interface::Mint>, // 在vault中质押的 Mint Account
    ...
    pub user_token_account: InterfaceAccount<'info, token_interface::TokenAccount>, // 用户与质押奖励代币关联的 Token Account
    #[account(
        mut,
    ...
    pub user_stake_entry: Account<'info, StakeEntry>, // 将在来自用户的 PDA 上创建的状态帐户，为其创建权益池，并将其STAKE_ENTRY_SEED作为种子。
